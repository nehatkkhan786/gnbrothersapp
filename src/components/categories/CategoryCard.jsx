...
const CategoryCard = ({catTitle, imgurl}) => {
    const screenWidth  = Math.floor(Dimensions.get('window').width) 
    const cardWidth = screenWidth / 2 -30
    const navigation = useNavigation()
  return (
    <>
    <TouchableOpacity onPress={()=>navigation.navigate('Products',{'category':catTitle})} style={{flexDirection:'row', width:cardWidth, alignItems:'center', justifyContent:'center', margin:4, borderRadius:20, position:'relative',}}>
