...
const ProductCard = ({productTitle, productImageUrl, productPrice}) => {
  ...
  return (
    <TouchableOpacity onPress={()=>navigation.navigate("ProductDetail", {"productitle":productTitle})} style={{width:cardWidth, alignItems:'center', justifyContent:'center', margin:2, borderRadius:20, backgroundColor:'white', padding:4, height:350 }}>
    ...
    <View  style={[styles.customBg, {alignItems:'flex-start', justifyContent:'flex-start', width:'100%', paddingHorizontal:10, paddingVertical:5,}]}>
        <Text style={{fontSize:16, fontWeight:500, color:'#555'}}>{productTitle}</Text>
